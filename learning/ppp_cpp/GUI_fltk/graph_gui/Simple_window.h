...
private:
	...
	// Another option is to use a lambda function for call back
	//static void cb_next(Address, Address addr) // callback for next_button - call Simple_window::next() for the window located at pw
	//{ 
